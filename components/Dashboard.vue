                ...
                <v-col>
                  <v-card align="left" class="mx-auto" outlined color="#ebeced">
                    <v-card-text>
                      ...
                      <h4 class="mt-2">SUBSCRIBERS REGISTERED YESTERDAY</h4>
                    </v-card-text>
                  </v-card>
                </v-col>
                <v-col>
                  <v-card align="left" class="mx-auto" outlined color="#ebeced">
                    <v-card-text>
                      ...
                      <h4 class="mt-2">SUBSCRIBERS REGISTERED LAST WEEK</h4>
                    </v-card-text>
                  </v-card>
                </v-col>
                <v-col>
                  <v-card align="left" class="mx-auto" outlined color="#ebeced">
                    <v-card-text>
                      ...
                      <h4 class="mt-2">SUBSCRIBERS REGISTERED LAST MONTH</h4>
                    </v-card-text>
                  </v-card>
                </v-col>
              </v-row>
...
export default {
  ...
  data() {
    return {
      ...
      selected: [],
      headers: [
        { text: 'Name', value: 'fund_name', class: 'size', sortable: false },
        { text: 'Amount(INR)', value: 'sum', class: 'size', sortable: false },
      ],
      search1: '',
      selected1: [],
      headers1: [
        { text: 'State', value: 'state', class: 'size', sortable: false },
        { text: 'Amount(INR)', value: 'sum', class: 'size', sortable: false },
      ],
      search2: '',
      selected2: [],
      headers2: [
        { text: 'City', value: 'city', class: 'size', sortable: false },
        { text: 'Amount(INR)', value: 'sum', class: 'size', sortable: false },
      ],
      search3: '',
      selected3: [],
      headers3: [
        { text: 'Device Model', value: 'device_model', class: 'size', sortable: false },
        { text: 'Count', value: 'count', class: 'size', sortable: false },
      ],
      search4: '',
      selected4: [],
      headers4: [
        { text: 'Name', value: 'dashboard_user', class: 'size', sortable: false },
      ...
      testrbac: {
      "dashboardSubscriber": true,
      "dashboardAmountInvested": true,
      "dashboardKycPendingCompleted": true,
      "dashboardRegistrationOverview": true
    },
  ...
  methods: {
    async check() {
      ...
      this.showtotal = this.$store.state.sessionStorage.rbac.dashboardSubscribers
      this.showinvested = this.$store.state.sessionStorage.rbac.dashboardAmountInvested
      this.showpending = this.$store.state.sessionStorage.rbac.dashboardKycPendingCompleted
      this.showoverview = this.$store.state.sessionStorage.rbac.dashboardRegistrationOverview
      this.showtop5fund = this.$store.state.sessionStorage.rbac.dashboardTop5FundsInvested
      this.showtop5cities = this.$store.state.sessionStorage.rbac.dashboardTop5InvestorCity
      this.showtop5states = this.$store.state.sessionStorage.rbac.dashboardTop5InvestorStates
      this.showtop5devices = this.$store.state.sessionStorage.rbac.dashboardTop5Phones
      this.superdis = this.$store.state.sessionStorage.rbac.dashboardSuperDistributors
      this.partnerdash = this.$store.state.sessionStorage.rbac.dashboardPartners
      this.subscribersinvitation = this.$store.state.sessionStorage.rbac.dashboardSubscribersInvitePendingAccepted
      this.top5dis = this.$store.state.sessionStorage.rbac.dashboardTop5SuperDistributors
      this.top5partners = this.$store.state.sessionStorage.rbac.dashboardTop5Partners
    ...
    kycTrue() {
      ...
      if (this.$store.state.sessionStorage.userType == 'partner' ) {
        if (this.$store.state.sessionStorage.rbac.mySubscribers == false) { 
        this.snackbar = true
        ...
        if (this.$store.state.sessionStorage.rbac.manageSubscribers == false) { 
        this.snackbar = true
        this.text = 'Sorry, You Do Not Have Permission To View This'
        this.color = 'red'
      } else { 
